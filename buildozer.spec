...
# (str) Package name
package.name = keysbook

# (str) Package domain (needed for android/ios packaging)
package.domain = com.github.qezawat.keysbook

# (str) Source code where the main.py live
source.dir = ./data/data/com.termux/files/home/keysbook-termux/
...
requirements = python3,kivy,pyjnius==1.6.1,requests,cryptography
